...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("Your BMI is = " + work03.MyUtil.calculateBMI(46, 1.57));
       System.out.println("Average is = " + work03.MyUtil.average(3, 3, 3));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      BankAccount acc1 = new BankAccount(5,A);
      
      Person B = new Person(2);
      BankAccount acc2 = new BankAccount(6,B);
