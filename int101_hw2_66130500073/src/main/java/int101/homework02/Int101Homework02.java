...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to 
        ...
        System.out.println(Utilitor.testString("Test testString : " + "Yuwarin"));
        ...
        //computeIsbn10
        System.out.println("Test computeIsbn10 : " + Utilitor.computeIsbn10(665789553));
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        Person p3 = new Person("Somchai", "Jaidee");
        Person p4 = new Person("Somsak", "Suksai");
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to
        ...
        Person p2 = new Person("Somchai", "Jaidee");
        Person p3 = new Person("Somsak", "Suksai");
